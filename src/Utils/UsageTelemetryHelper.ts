import { UsageFeatureProps, pickUserEvent, UserEvent, UsageEventName, pickSystemEvent, SystemEvent } from '../Models';
...
export function getFeature(
    ...
    return {
        ...
        subFeatureLevel2: Array.isArray(subCapabilityLevel2)
            ? subCapabilityLevel2.join('.')
            : subCapabilityLevel2 || '',
