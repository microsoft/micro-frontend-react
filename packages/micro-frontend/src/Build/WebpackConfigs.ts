...
<html lang="en">
    ...
    <body class="ms-Fabric" dir="ltr">
        ...
        <script src="https://ee.azureedge.net/react-router-dom/5.3.0/react-router-dom.min.js"></script>
        <script src="https://ee.azureedge.net/styled-components/5.3.3/styled-components.min.js"></script>
