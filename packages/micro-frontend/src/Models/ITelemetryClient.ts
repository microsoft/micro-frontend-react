...
export interface ITelemetryClient extends Omit<IAppInsights, 'getCookieMgr'> {
   ...
   */
  stopTrackEvent(name: string, properties?: Record<string, unknown>, measurements?: Record<string, unknown>): unknown;

  stopTrackEvent(props?: Record<string, unknown>, measures?: Record<string, unknown>): undefined;
  ...
  trackCustomEvent(event: IEventTelemetry, customProperties?: CustomProperties): void;
   ...
   * @param {object} customProperties Property bag to log OBJECTS and their key/value pairs into "properties" (works with sub-objects)
   */
  trackEvent(event: IEventTelemetry, customProperties?: CustomProperties): unknown;
   ...
   * @param {object} customProperties Property bag to log OBJECTS and their key/value pairs into "properties" (works with sub-objects)
   */
  trackEvent(customProperties?: { [key: string]: unknown }): unknown;
