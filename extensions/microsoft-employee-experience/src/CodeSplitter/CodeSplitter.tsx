...
export class CodeSplitter<T> extends React.Component<ICodeSplitterProps<T>, ICodeSplitterState<T>> {
  ...
  public render(): JSX.Element | null {
    ...
    const Component: React.ComponentType<T> | null = this.state.Component;
